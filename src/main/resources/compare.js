...
/*var PlayMustache = function () {
        var meta = document.getElementById("play-mustache-templates");
        var mdata = JSON.parse(decodeURIComponent(meta.content));
        //console.log(mdata);
        return {
            to_html: function (key, context) {
                var tmpl = mdata.templates[key];
                console.log(tmpl)
                var partials = {};
                ...
                for (var i = 0, len = (rawPartials == null ? 0 : rawPartials.length); i < len; i++) {
                    ...
                    partials[key] = mdata.templates[name + '.html'];
                }
